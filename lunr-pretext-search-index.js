...
},
{
  ...
  "body": " Special elements of    zero vectors of , and     indicator vector of    Let be a nonempty set.   Zero vector  The zero vector of , denoted (or for short), is the -tuple, all of whose entries are equal to : , .  In the special cases and , we denote the corresponding zero vectors as and , respectively.    Vector inverse  Given an -tuple , the vector inverse of , denoted , is the element of defined as .    Indicator vectors  Given , the -th indicator element of , denoted , is the -tuple whose -th entry is equal to and whose -th entry is equal to for all .  In the case , we call the -th standard basis vector of .  In the case , we write for , and call this the -th standard basis vector of .      "
},
{
...
{
  "id": "ss_tuples_vector_ops-20",
  "level": "2",
  "url": "s_Rn_and_friends.html#ss_tuples_vector_ops-20",
  "type": "Example",
  "number": "1.1.21",
...
{
  "id": "ss_tuples_vector_ops-21",
  "level": "2",
  "url": "s_Rn_and_friends.html#ss_tuples_vector_ops-21",
  "type": "Example",
  "number": "1.1.22",
